...
public class Xiao {  
    double HP;
    double baseAtk; //base atk with lvl90 homa
    double atkPercent; //= 9.9 + 11.7 + 46.6 + 46.6+ 10.0 + 18.0; //10 from 4vh and 18 from 2vh
    double flatAtk;//29 + 54 + 31 + 311; // flat atk from artifacts
    double atk;  
    double cd;
    double dmgBonus;
   ...
   public double dmgMultiplier(double atk, double cd, double eleDmgBonus){
      ...
      dmgMultiplier = atk*(1+cd/100)*(1+eleDmgBonus/100)*defenceMitigation(90, 90)*resistanceMultiplier(resistanceShred, mobResist);
